...
public class JiveGlobe {
	...
	//验证图片格式
        ...
        public static boolean isEmpty(JSONObject json,String  json1,String json2) {
    		if(null==json ||!json.has(json1) || !json.has(json2)){
    			return true;
    		}
    		return false;
    	}
        
        public static boolean isEmpty(JSONObject json,String json1,String json2,String json3,String json4){
    		if(null==json ||!json.has(json1) || !json.has(json2)  || !json.has(json3)  || !json.has(json4)){
    			return true;
    		}
        	return false;
        }
        
        public static boolean isEmpty(String  json1,String json2,JSONObject json,String json3) {
     		if(null==json ||!json.has(json1) || !json.has(json2)|| !json.has(json3)){
     			return true;
     		}
     		return false;
     	}
        
        public static boolean isEmpty(String  json1,String json2,String json3,String json4,String json5,JSONObject json) {
     		if(null==json ||!json.has(json1) || !json.has(json2)|| !json.has(json3) || !json.has(json4) || !json.has(json5)){
     			return true;
     		}
     		return false;
     	}
        
        public static boolean isEmpty(String  json1,String json2,String json3,String json4,String json5,String json6,JSONObject json) {
     		if(null==json ||!json.has(json1) || !json.has(json2)|| !json.has(json3) || !json.has(json4) || !json.has(json5)){
     			return true;
     		}
     		return false;
        ...
        public static boolean isEmpty(String  json1,String json2,String json3,String json4,String json5,String json6,String json7,JSONObject json) {
     		if(null==json ||!json.has(json1) || !json.has(json2)|| !json.has(json3) || !json.has(json4) || !json.has(json5)){
     			return true;
     		}
     		return false;
